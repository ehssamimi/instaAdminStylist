...
function SelectTrigger({
  ...
  const [innerTitle, setInnerTitle] = React.useState("")

  React.useEffect(() => {
    if (title !== undefined) return
    const el = ref.current?.querySelector<HTMLSpanElement>("span:first-child")
    if (el) {
      setInnerTitle(el.textContent ?? "")
    }
