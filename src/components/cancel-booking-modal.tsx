...
type CancelBookingModalProps = {
  ...
  /** Called with the reason when the user confirms. Stays open on rejection. */
      ...
      >
        ...
        <div className="flex flex-col gap-6 p-5">
          <p className="font-satoshi text-sm font-bold leading-relaxed text-black">
            Are you sure you want to cancel the call? The customer receives a full refund.
          </p>

          <p className="font-satoshi text-sm font-normal leading-relaxed text-black">
            Please provide a reason for cancelling this booking. This reason will be shared with the customer and stylist.
          </p>
